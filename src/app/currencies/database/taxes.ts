import { TaxeRatesList, ProvinceType } from "src/app/types/types";

export const taxeRates: TaxeRatesList = [
    {name: 'Canada', provStatus: ProvinceType.Federal, taxes: [
    ...
    {name: 'Alberta', provStatus: ProvinceType.Province, taxes: [
    ...
    {name: 'British Columbia', provStatus: ProvinceType.Province, taxes: [
    ...
    {name: 'Manitoba', provStatus: ProvinceType.Province, taxes: [
        {backet: 0, rate: 0.1080},
        {backet: 33724, rate: 0.1275},
        {backet: 72885, rate: 0.1740},
    ]},
    {name: 'New Brunswick', provStatus: ProvinceType.Province, taxes: [
    ...
    {name: 'Newfoundland and Labrador', provStatus: ProvinceType.Province, taxes: [
    ...
    {name: 'Nova Scotia', provStatus: ProvinceType.Province, taxes: [
    ...
    {name: 'Ontario', provStatus: ProvinceType.Province, taxes: [
    ...
    {name: 'Nunavut', provStatus: ProvinceType.Terretory, taxes: [
        {backet: 0, rate: 0.1500},
        {backet: 44546, rate: 0.2000},
        {backet: 89081, rate: 0.2400},
        {backet: 108390, rate: 0.2575},
